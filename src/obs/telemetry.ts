 ...
 * тексты ответов. Она живёт в бутстрапе (`otel.instrument.mjs`) и уже на месте. Сегодня ей нечего
 * чистить — авто-инструментирование не подключено (причины в §Ключевые решения), — но она стоит
 * заранее: ставить её в день включения было бы поздно.
 */
