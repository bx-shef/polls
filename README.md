...
встроенных данных (БД не нужна), прод-хранение в PostgreSQL — шаг деплой-слоя (#6).
Полная инструкция, секреты и тест-лист — [**инструкция администратора**](./docs/admin-setup.md).
...
- [**Как работает приложение**](./docs/process.md) — процесс «от и до» простыми словами.
- [**Концепция для клиента**](./docs/concept.md) — зачем сервис и что он даёт (без жаргона).
- [**Инструкция администратора**](./docs/admin-setup.md) — установка, секреты, демо/прод, эксплуатация.
