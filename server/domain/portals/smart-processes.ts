 ...
 * подтверждены живыми порталами. Каждый из них расходится с тем, что я сделал бы
 * по документации, и каждый отмечен ниже.
 */
 ...
 * («not allowed to view custom field settings») — подтверждено соседом живьём.
 */
