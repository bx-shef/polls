...
const AREAS = [
  ...
  {
    files: ['test/invitation-retention.test.ts', 'test/invitation-wiring.test.ts', 'test/install-wiring.test.ts', 'test/close-invite.test.ts', 'test/manual-invite.test.ts', 'test/result-view-route.test.ts', 'test/dashboard-view.test.ts', 'test/crm-names.test.ts', 'test/install-gate.test.ts', 'test/post-result.test.ts', 'test/close-invite-wiring.test.ts', 'test/tenant-wiring.test.ts', 'test/demo-seed-wiring.test.ts'],
