...
редактор (`[key].vue`) поверх `GET …/:key` + `POST …/:key/publish` (правка заголовка/текстов вопросов/
стадий → публикация новой версии; MVP, drag-and-drop конструктор — фаза полировки). Нативная b24ui-тема,
