...
/**
 * Привязка `member_id` к OAuth-гранту при установке (docs/project-map.md, §Установка и lifecycle
 * портала — анти install-poisoning). Проблема: `member_id` в install-POST — КЛИЕНТ-КОНТРОЛИРУЕМОЕ поле, а
 ...
 * бы ошибку на легитимной гонке. См. docs/project-map.md, §Установка и lifecycle портала (follow-up).
 */
