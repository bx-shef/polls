...
- Подавление малых выборок — **два уровня, и живут они в разных местах**: (1) гейт по общему N
  ...
  СЫРЫМИ. ⚠️ Переводя дашборд на SQL-агрегацию (#49), подавление по ячейкам надо перенести явно —
  иначе оно исчезнет без единого красного теста. Пагинация и tenant-изоляция (`portalId`) — слой
