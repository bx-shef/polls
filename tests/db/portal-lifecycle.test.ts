 ...
 * недоставленные ответы и выпущенные ссылки. Соседний `inbox-claim.test.ts` уже избегает
 * этого и чистит по своему домену; здесь конвенцию нарушили. Нашла панель ревью PR #34.
 */
