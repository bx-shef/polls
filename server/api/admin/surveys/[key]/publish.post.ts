 ...
 * /api/submit, ради точного текста отказа; chunked-тело без заявленной длины отсекает раньше общий
 * бэкстоп `server/middleware/body-limit.ts` (411), до маршрутизации.
 *
