-- Миграция 0004: устойчивость OAuth-lifecycle портала (docs/project-map.md, §Установка и lifecycle портала).
...
-- порталы у истечения по этому столбцу (keep-alive-рефреш).
...
-- обработка uninstall (следующий шаг). Столбец готовим заранее.
...
-- после uninstall не воскрешает удалённый портал; TTL-подметание тумбстоунов — follow-up.
