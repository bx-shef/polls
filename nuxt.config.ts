...
export default defineNuxtConfig({
  ...
  // берём только его, своих реализаций того, что уже есть, не пишем. На публичную страницу
  // анкеты он намеренно НЕ распространяется — она живёт вне портала и со своей вёрсткой.
