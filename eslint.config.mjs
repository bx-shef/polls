...
const AREAS = [
  ...
  {
    files: ['test/invitation-retention.test.ts', 'test/invitation-wiring.test.ts', 'test/install-wiring.test.ts', 'test/close-invite.test.ts', 'test/close-invite-wiring.test.ts', 'test/tenant-wiring.test.ts'],
